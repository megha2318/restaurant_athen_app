                        ...
                        InkWell(
                          onTap: () async {
                            ...
                            if (selected != null) {
                              ...
                              homeController.getYear.value = selected.year;

                              homeController.month.value = (selected.month ==
                                      01)
                                  ? "January"
                                  : (selected.month == 02)
                                      ? "February"
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "${homeController.dashboardObjModel.value.data![index].clientName}"
                                                                .tr,
                                                            style: appTextStyle(
                                                                fontSize: 15),
                                                          ),
                                                          RichText(
                                                            text: TextSpan(
                                                              children: [
                                                                ...
                                                                TextSpan(
                                                                  text:
                                                                      ('${homeController.dashboardObjModel.value.data![index].keyNumber}'),
                                                                  recognizer:
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        Text(
                                                          "${homeController.dashboardObjModel.value.data![index].address}"
                                                              .tr,
                                                          style: appTextStyle(
                                                              fontSize: 10,
                                                              fontWeight:
